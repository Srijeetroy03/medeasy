...
function ProfileForm() {
    ...
    try {
      await dispatch(
        completeProfile({
          ...
          degree,
          phone,
          timing: { timeFrom: timingFrom, timeTo: timingTo },
          address,
          days: days && days.includes(",") ? days.split(",") : "",
          city,
          state,
          country,
        })
  ...
  return (
    <>
      {userInfo && !role && (
        <div className="flex flex-col w-full p-10 px-6 md:p-10 gap-8 font-poppins">
          <h2 className="font-poppins font-bold text-3xl capitalize text-center">
            Select a role that perfectly fits for you
          </h2>
          <div className="flex flex-col md:flex-row gap-4 w-full items-center justify-evenly pt-8">
            <button
              onClick={() => setRole("Normal")}
              className="border w-56 h-56 hover:scale-110 hover:bg-green-500 text-white bg-green-600 rounded transition-all p-2"
              type="submit"
            >
              Normal User
            </button>
      ...
      {userInfo && role && (
        <div className="flex flex-col w-full font-poppins p-10 px-6 md:p-10 gap-8">
          <h2 className="font-poppins font-bold text-3xl">
            You're just one step away from finishing the resgistration process!
          </h2>
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div className="flex flex-col input-grp relative animate-form ">
              ...
              <input
                ...
                className={`focus:outline-0 border-b-2  transition-colors bg-blue-100 p-2 ${
                  role === "Doctor" && "pl-12"
                }`}
                type="text"
                name="name"
              ...
              />
              {role === "Doctor" && (
                <p className="absolute bottom-0 left-0 p-2">Dr.</p>
              )}
            </div>
            <div className="flex flex-col input-grp relative animate-form delay-15">
              ...
              <input
                ...
                className="focus:outline-0 border-b-2  transition-colors p-2 pl-12 bg-blue-100"
                type="text"
                name="username"
                id="username"
              />
            ...
            {role === "Doctor" && (
              <Dropdown
                options={doctorSpecialities.map((spec) => spec.name)}
                onChange={_onSelect}
                value={doctorSpecialities.map((spec) => spec.name)[0]}
                placeholder={"Select Your Speciality"}
              />
            )}
            {Speciality === "Other" && role === "Doctor" && (
              <div className="flex flex-col input-grp relative animate-form delay-15">
                ...
                <input
                  ...
                  className="focus:outline-0 border-b-2  transition-colors p-2"
                  type="text"
                  name="speciality"
                  id="speciality"
                />
            ...
            {role === "Doctor" && (
              <div className="flex flex-col input-grp relative animate-form delay-15">
                ...
                <input
                  ...
                  className="focus:outline-0 border-b-2  transition-colors p-2 bg-blue-100"
                  type="number"
                  name="experience"
                  id="experience"
                />
            ...
            {role === "Doctor" && (
              <div className="flex flex-col input-grp relative animate-form delay-15">
                ...
                <input
                  ...
                  placeholder="Enter comma separated Degrees"
                  className="focus:outline-0 border-b-2  transition-colors p-2 bg-blue-100"
                  type="text"
                  name="degree"
                  id="degree"
              ...
              <div className="flex flex-col input-grp relative animate-form delay-15">
                ...
                <div className="flex flex-row w-full items-center justify-between gap-2">
                  <div className="flex flex-col input-grp delay-15 animate-form w-full">
                    <label className="" htmlFor="timeFrom">
                      From
                    </label>
                    <input
                      required
                  ...
                  <div className="flex flex-col input-grp delay-15 animate-form w-full">
                    <label className="" htmlFor="timeTo">
                      To
                    </label>
                    <input
                      required
            ...
            {role === "Doctor" && (
              <div className="flex flex-col input-grp relative animate-form delay-15">
                ...
                <input
                  ...
                  placeholder="Enter Comma Separated Days"
                  className="focus:outline-0 border-b-2  transition-colors p-2 bg-blue-100"
                  type="text"
                  name="days"
                  id="days"
            ...
            {role === "Doctor" && (
              <div className="flex flex-col input-grp relative animate-form delay-15">
                ...
                <input
                  ...
                  className="focus:outline-0 border-b-2  transition-colors p-2 bg-blue-100 font-poppins"
                  name="address"
                  id="address"
                />
              </div>
            ...
            <div className="flex flex-col input-grp relative animate-form delay-15">
              ...
              <input
                ...
                placeholder="Enter your contact mumber"
                className="focus:outline-0 border-b-2  transition-colors p-2 bg-blue-100 font-poppins"
                type="tel"
                name="phone"
                id="phone"
            ...
            <div className="flex flex-col input-grp relative animate-form delay-3">
              ...
              <p className="focus:outline-0 border-b-2  transition-colors p-2 bg-blue-100 font-poppins">
                {userInfo.email}
              </p>
            </div>
            ...
            <button
              className="btn  bg-green-600 hover:bg-green-500 rounded text-white px-4 py-2 transition-all"
              type="submit"
            >
              Submit
            </button>
