    ...
    <>
      ...
      <div className="flex flex-col w-full flex-wrap font-poppins py-8">
        <div
          id="profileHead"
          ref={profileRef}
          className="w-full fixed gap-4 left-0 px-2 md:px-16 py-2 -top-16 md:pt-4 h-16 bg-white border-b-2 border-gray-100 items-center md:items-center overflow-hidden object-center flex flex-row transition-all"
        >
          <img
            draggable={false}
            src={
          ...
          <div className="font-poppins  p-8 flex flex-col gap-4">
            <h2 className="text-4xl font-extrabold flex gap-4">
              ...
              {userInfo?._id === id && !show && (
                <button
                  onClick={handleShow}
                  className="p-2 bg-gray-200 shadow-lg rounded-full flex items-center justify-center"
                >
                  <EditRoundedIcon />
                </button>
              )}
